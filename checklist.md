...
| *.vue | 所有 import 有 JSDoc 注释 包含 @description ...                                         |      |
| *.vue | 所有变量有 JSDoc 注释 ref、reactive、computed、let 等                                   |      |
| *.vue | 所有函数有完整 JSDoc 注释 @param、@returns、@description                                |      |
| *.vue | 所有 watch 有 JSDoc 注释                                                                |      |
| *.vue | 所有生命周期钩子有 JSDoc 注释                                                           |      |
| *.vue | 无单行注释 改用 JSDoc 风格                                                              |      |
| *.vue | 无被注释掉的代码 如有则删除                                                             |      |

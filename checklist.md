...
| index.ts | name 属性有 JSDoc 注释 多行格式 1.标题 2.@description                                                                                       |                                                    |
...
| \*.vue   | 所有 import 有 JSDoc 注释 多行格式 1.标题 2.@description                                                                                    |                                                    |
| \*.vue   | 所有变量有 JSDoc 注释 多行格式 1.标题 2.@description（ref、reactive、computed、let 等）                                                     |                                                    |
| \*.vue   | 所有函数有完整 JSDoc 注释 多行格式 1.标题 2.@param 3.@returns 4.@description                                                                |                                                    |
| \*.vue   | 所有 watch 有 JSDoc 注释 多行格式 1.标题 2.@description                                                                                     |                                                    |
...
| \*.ts    | 所有 import 有 JSDoc 注释 多行格式 1.标题 2.@description                                                                                    |                                                    |
| \*.ts    | 所有 export 有 JSDoc 注释 多行格式 1.标题 2.@type 3.@description                                                                            |                                                    |
| \*.ts    | 所有函数有完整 JSDoc 注释 多行格式 1.标题 2.@param 3.@returns 4.@description                                                                |                                                    |
| \*.ts    | 所有方法必须使用 function 定义 而非 const 定义                                                                                              |                                                    |
| \*.ts    | 所有变量/常量有 JSDoc 注释 多行格式 1.标题 2.@description                                                                                   |                                                    |
| \*.ts    | 无单行注释 改用 JSDoc 注释 多行格式 1.标题 2.@description                                                                                   |                                                    |
| \*.ts    | 数组类型使用 Array                                                                                                                          |                                                    |
| \*.ts    | 可选参数类型含 undefined                                                                                                                    |                                                    |
| \*.ts    | 代码顺序规范 import → const/let 变量（vue 相关）→ const/let 其他变量 → function → vue 的 watch                                              |                                                    |

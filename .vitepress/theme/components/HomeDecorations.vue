...
onMounted(() => {
  ...
  // 设置更新时间
  const now = new Date()
  lastUpdate.value = `${now.getFullYear()}-${String(now.getMonth() + 1).padStart(2, '0')}-${String(now.getDate()).padStart(2, '0')}`
  ...
  fetch('https://api.github.com/repos/SaltedFish-Cai/Butler-AI-Website')
    ...
    .then(data => {
      if (data.stargazers_count) {
        stars.value = data.stargazers_count >= 1000 
  ...
  <div class="home-decorations">
    ...
    <div class="floating-code">
      <div class="code-block">
        ...
        <span class="package">pancake-ui</span>
      </div>
    </div>
    ...
    <div class="tech-icons">
      ...
      <div class="tech-icon vite" title="Vite">
        <svg viewBox="0 0 128 128">
          ...
          <path fill="url(#vite-a)" d="M124.77,18.21L67.5,123.81c-1.18,2.11-4.24,1.19-4.24-1.26V70.53H13.24c-2.25,0-3.29-2.77-1.68-4.31L121.09,14.32C122.84,12.64,125.59,15.31,124.77,18.21Z"/>
          <path fill="url(#vite-b)" d="M124.77,18.21L67.5,123.81c-1.18,2.11-4.24,1.19-4.24-1.26V70.53L121.09,14.32C122.84,12.64,125.59,15.31,124.77,18.21Z"/>
        </svg>
      </div>
    </div>
...
.prompt { color: #6c7086; margin-right: 8px; }
.command { color: #89b4fa; }
.package { color: #a6e3a1; font-weight: 600; margin-left: 8px; }

...
| popoverClass      | 弹窗类名         | `string`                                  | `undefined` |
| style             | 自定义样式       | `Record<string, string>`                  | `undefined` |
| referenceStyle    | 参考元素样式     | `Record<string, string>`                  | `undefined` |
...
| sticky            | 是否粘性定位     | `"left" | "right" | undefined`          | `undefined` |
| closeByScroll     | 是否点击滚动关闭 | `boolean`                                 | `true`     |
| beforeClose       | 关闭前回调       | `() => boolean`                           | `undefined` |

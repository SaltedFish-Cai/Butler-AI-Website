...
| onClick        | 点击回调函数                                                                 | `(event?: MouseEvent) => void`                                                     | `undefined` |
| onConfirmClick | 确认点击回调函数                                                             | `() => void` `undefined`                                                           | `undefined` |
| onSubmitClick  | 提交点击回调函数                                                             | `() => void` `undefined`                                                           | `undefined` |
| onDeleteClick  | 删除点击回调函数                                                             | `() => void` `undefined`                                                           | `undefined` |

<template>
  ...
  <sa-tabs v-model="activeName">
    <sa-tabs-item label="第一页" name="page1" class="card_style" :padding="['all']" use-border> page1 </sa-tabs-item>
    <sa-tabs-item label="第二页" name="page2" class="card_style" :padding="['all']" use-border> page2 </sa-tabs-item>
  </sa-tabs>

  <sa-title :padding="['bottom']">非Card样式</sa-title>
  <sa-tabs v-model="activeName" styleMode="default" align="edge">
...
const activeName3 = ref("page1");
const activeName4 = ref("page1");
</script>

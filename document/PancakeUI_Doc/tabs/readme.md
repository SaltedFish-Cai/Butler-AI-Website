...
| styleMode     | 样式模式         | [`ComponentTabsStyleMode`](#componenttabsstylemode) | `card`    |
| align         | 对齐方式         | [`ComponentTabsAlign`](#componenttabsalign)     | `default` |
| useHeaderLine | 是否使用底线     | `boolean`                                       | -         |
...
| scroll     | 是否开启滚动       | `boolean`                                                                    | -       |
| tips       | 提示信息           | `string`                                                                     | -       |
| lazy       | 懒加载             | `boolean` `number`                                                           | -       |
| padding    | 内边距方向         | [`Array<ComponentPadding>`](#componentpadding)                               | -       |
| useScrollX | 是否使用水平滚动   | `boolean`                                                                    | -       |
| useBorder  | 是否使用边框       | `boolean`                                                                    | -       |

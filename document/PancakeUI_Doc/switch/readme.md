...
| activeIcon | 激活状态图标 | `string` | — |
| inActiveIcon | 非激活状态图标 | `string` | — |
...
| iconStyle    | 图标样式         | `Record<string, string>`        | `undefined` |
| activeIcon   | 打开图标         | `string`                        | `undefined` |
| inActiveIcon | 关闭图标         | `string`                        | `undefined` |

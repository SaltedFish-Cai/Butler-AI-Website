...
function openEditDialog(formId: string, config: SaStructureType.FormV2[], options: Record<string, string>) {
  editId.value = formId;
...
const emit = defineEmits<{
  handleEditFormItemQuickSubmit: [formId: string, data: SaStructureType.FormV2[], options: Record<string, string>];
}>();

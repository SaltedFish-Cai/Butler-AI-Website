 ...
 */
Notification.success = function (options: NotificationOptions | string): NotificationInstance {
  if (typeof options === "string") {
 ...
 */
Notification.warning = function (options: NotificationOptions | string): NotificationInstance {
  if (typeof options === "string") {
 ...
 */
Notification.danger = function (options: NotificationOptions | string): NotificationInstance {
  if (typeof options === "string") {
 ...
 */
Notification.info = function (options: NotificationOptions | string): NotificationInstance {
  if (typeof options === "string") {

...
export type SaFileType = {
  ...
  /**
   * **双向绑定数据**
   * @type `Array<SaFileDataType>`
   * @default `undefined`
   * @description 当设置该值时，会绑定该值
   * @description 当前属性只有作为 `独立组件` 时才会生效
   * @description 该值的类型为 `Array<SaFileDataType>`，可以是任意类型
   * */
  modelValue?: Array<SaFileDataType>;
   ...
   * ```
   * */
  contrastData?: Array<SaFileDataType>;

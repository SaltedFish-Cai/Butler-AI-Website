<template>
  <div v-if="!display" class="pa-input" :class="[props.class, { 'is-disabled': disabled }]" :style="{ ...props.style }">
    <!-- textarea -->
    <div v-if="type == 'textarea'" class="pa-input-textarea" :class="[isFocus ? 'is-focus' : '']">
      <textarea
        ref="textareaRef"

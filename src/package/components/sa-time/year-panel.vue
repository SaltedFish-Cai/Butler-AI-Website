  ...
  <div class="m-year-month-picker-panel">
    ...
    <div class="m-year-month-picker-panel-main">
      ...
      <div class="m-year-month-picker-footer">
        <sa-button @click="handleCancel" is="trash" type="default">清空</sa-button>
        <sa-button @click="confirmSelection" font="check_line" type="primary">确定</sa-button>
      </div>
    </div>
  </div>
</template>
...
.month-cell {
  ...
  &.disabled {
    color: var(--sa-color-info-light-4);
    cursor: not-allowed;
  }
  ...
  &.in-range {
    border-radius: 0;
    color: var(--sa-color-font) !important;
    background-color: var(--sa-color-scrollbar) !important;
  }
}

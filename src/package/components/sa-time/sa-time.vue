<template>
  ...
  >
    ...
    >
      <template #reference>
        <div class="sa-time-content">
          <div v-if="!isRange" class="sa-time-input" :class="[isFocus ? 'is-focus' : '']">
            <!-- input -->
            <input
              class="sa-time-input-inner"
              v-model="inValue"
          ...
          <div v-else class="sa-time-input" :class="[isFocus ? 'is-focus' : '']">
            <!-- input -->
            <input
              class="sa-time-input-inner center"
              v-model="inValue[0]"
...
const props = withDefaults(defineProps<SaTimeType>(), {
  id: randChar(),
  type: "date-picker"
});

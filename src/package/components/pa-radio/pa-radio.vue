<template>
  <div v-if="!display" :id="randId" class="pa-radio" :class="[props.class]" ref="selectRef" :style="props.style" :disabled="props.disabled">
 ...
 */
const randId = ref((props.id ? props.id + "_" : "") + "pa-radio_" + useRenderId());
/**
 * 组件事件定义

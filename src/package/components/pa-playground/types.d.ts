/**
 * @module pa-playground/types
 * @description PaPlayground 类型定义
 */
/**
 * @description 导入类型定义
 */
...
export type MInterfaceConfig = {
  ...
  apiUrl: string;
  /**
   * @type "delete" | "get" | "post" | "put" @default undefined
   * @description API 请求类型
   */
...
export type MOptionsType = {
  ...
  description: string;
  /**
   * @type "interface" | "select" | "switch" @default undefined
   * @description 选项类型
   */
  OptionsType: "interface" | "select" | "switch";
  /**
   * @type PaOptionType.SelectList | PaOptionType.Switch @default undefined
   * @description 选项配置
   */
...
export type MStructureTypeItem = {
  ...
  description: string;
  /**
   * @type LanguagePackageType @default undefined
   * @description 标签
   */
...
export type MStructureType = {
  ...
  indexKey: string;
  /**
   * @type Array<MStructureTypeItem> @default undefined
   * @description 配置项列表
   */
...
export type PaPlaygroundItem = {
  ...
  height: number;
  /**
   * @type "form" | "table" | "tabs" @default undefined
   * @description 项目类型
   */
  ...
  /**
   * @type string @default undefined
   * @description 操作 API 标识
   */
  actionApi?: string;
  /**
   * @type LanguagePackageType | object @default undefined
   * @description 标题
   */
...
export type PaPlaygroundPagesType = {
  ...
  y: number;
  /**
   * @type Array<PaPlaygroundItem> @default undefined
   * @description 项目配置列表
   */
...
export type PaPlaygroundType = {
  ...
  adminScale: number;
  /**
   * @type Array<PaPlaygroundPagesType> @default undefined
   * @description 页面配置列表
   */
  pagesConfigs: Array<PaPlaygroundPagesType>;
  /**
   * @type Array<MInterfaceConfig> @default undefined
   * @description 接口配置列表
   */
  interfaceConfigs: Array<MInterfaceConfig>;
  /**
   * @type Array<MStructureType> @default undefined
   * @description 数据结构列表
   */
  dataStructures: Array<MStructureType>;
  /**
   * @type Array<MOptionsType> @default undefined
   * @description 扩展选项列表
   */
...
export type PaPlaygroundActionFunctionType = {
  ...
  executionDependencies: Array<{
    ...
    key: string;
    /**
     * @type "input" | "select" @default undefined
     * @description 类型
     */
    type: "input" | "select";
    /**
     * @type PaOptionType.SelectList @default undefined
     * @description 扩展选项
     */
...
export type ComponentProps = {
  ...
  requestFunction?: any;
  /**
   * @type Array<PaOptionType.Select & PaPlaygroundActionFunctionType> @default undefined
   * @description 操作函数数组
   */

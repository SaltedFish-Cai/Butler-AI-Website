...
export type PaPlaygroundPageButtonType = {
  ...
  /**
   * @type "danger" | "default" | "info" | "primary" | "success" | "warning" @default undefined
   * @description 按钮类型
   */
  ...
  icon: string;
  /**
   * @type "dialog" | "HeaderCenter" | "HeaderLeft" | "operation" | "ToolButtonInline" @default undefined
   * @description 使用类型
   */
  useType?: "dialog" | "HeaderCenter" | "HeaderLeft" | "operation" | "ToolButtonInline";
  /**
   * @type ButtonTypeV2Is @default undefined
   * @description 按钮类型
   */
  is?: ButtonTypeV2Is;
  /**
  ...
  /**
   * @type "Built" | "Custom" @default undefined
   * @description 样式类型
   */
  styleType: "Built" | "Custom";
  /**
   * @type string | "delete" | "dialog" | "jump" | "null" | "save" @default undefined
   * @description 操作类型
   */

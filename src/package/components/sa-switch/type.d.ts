...
export type SaSwitchType = SaSwitchOptionType & {
  /**
   * **组件唯一标识**
   ...
   * @example
   * ```tsx
   * <SaSwitch exOptions={{ activeValue: true, inActiveValue: false }} />
   * ```
   * */
  exOptions?: SaSwitchOptionType;
   ...
   * @example
   * ```tsx
   * <SaSwitch onChange={({ value, oldValue }) => { console.log(value, oldValue) }} />
   * ```
   * */

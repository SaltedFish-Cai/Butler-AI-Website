  ...
  <div class="editor-toolbar">
    <template v-for="tool in toolbarTools" :key="tool.command">
      <sa-popover
        ...
        :popover-class="'sa-editor-toolbar'"
        trigger="click"
      ...
      >
        <template #reference>
          ...
          >
            ...
            <sa-icon v-else :name="tool.icon"></sa-icon>
          </button>
        </template>
        ...
        <div class="sa-editor-toolbar_input" v-else-if="tool.command == 'createLink'">
          <input
          ...
          <div
            class="sa-editor-toolbar_input-del"
            @click="
        ...
        <div v-else class="sa-editor-toolbar_array">
          <template v-for="child in tool.children" :key="child.command + child.value">
            ...
            >
              <!-- {{ tool.icon }} -->
              <sa-icon :name="child.icon"></sa-icon>
            </button>
          </template>
        </div>
      </sa-popover>
      ...
      <button
        ...
        :disabled="isSourceCodeMode != 'edit'"
      >
        <sa-icon :name="tool.icon"></sa-icon>
        <input
          ref="fileInput"
          type="file"
          accept="image/*"

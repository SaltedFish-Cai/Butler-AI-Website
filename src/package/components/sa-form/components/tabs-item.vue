  ...
  <template v-if="item.type == 'tabs-form' && item.prop">
    <sa-form-item :prop="item.prop">
      ...
      >
        ...
        >
          <template #label>
            ...
            <templage v-if="injectConfigContext.display || item.disabled">
              <div class="sa-form_tabs-title" :class="[tab.isError ? 'sa-form_tabs-title_error' : '']">
            ...
            <template v-else-if="tab.name != editTitleIndex">
              <div :class="['flex-center-start', 'tabs-item-title', tab.isError ? 'sa-form_tabs-title_error' : '']">
        ...
        >
          <template #label>
            <div class="sa-form_tabs-title deleted">
          ...
          <!-- form -->
          <section class="tabs-form-body flat-style">
            <sa-form-control :id="id + '-tabs-form'" :model="tab" inTabsForm @validation-states="validateTabsForm">
              <!-- v-show 防闪烁 -->
              <!-- v-show="stepsIndex == tab.name" -->

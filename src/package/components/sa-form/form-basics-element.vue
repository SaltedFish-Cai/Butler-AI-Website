<template>
  <template v-if="item.prop">
    <!-- other-item -->
    <sa-col :xs="colSize" :sm="colSize" :md="colSize" :lg="colSize" :xl="colSize" :span="item.colSpan">
      <sa-form-item
  ...
  <!-- null -->
  <sa-col v-else-if="item.type == 'null'" :xs="colSize" :sm="colSize" :md="colSize" :lg="colSize" :xl="colSize"> </sa-col>
</template>

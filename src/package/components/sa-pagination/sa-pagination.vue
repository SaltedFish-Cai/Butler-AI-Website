<template>
  <div class="sa-pagination" :class="[props.class]" :style="{ ...props.style }">
    <!-- 总条数 -->
    ...
    >
      <sa-icon name="left_line"></sa-icon>
    </button>
    ...
    <button
      ...
      @click="goToPage(internalCurrentPage + 1)"
    >
      <sa-icon name="right_line"></sa-icon>
    </button>
...
import { SaPaginationType } from "./type";

const props = withDefaults(defineProps<SaPaginationType>(), {
  currentPage: 1,
  pageSize: 10,
